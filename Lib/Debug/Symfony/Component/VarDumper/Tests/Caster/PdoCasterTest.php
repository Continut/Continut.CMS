...
namespace Debug\Symfony\Component\VarDumper\Tests\Caster;

use Debug\Symfony\Component\VarDumper\Caster\PdoCaster;
use Debug\Symfony\Component\VarDumper\Cloner\Stub;
...
class PdoCasterTest extends \PHPUnit_Framework_TestCase
{
    public function testCastPdo()
    {
        ...
        $this->assertInstanceOf('Debug\Symfony\Component\VarDumper\Caster\ConstStub', $attr['CASE']);
