...
use Debug\Symfony\Component\VarDumper\Dumper\CliDumper;
use Debug\Symfony\Component\VarDumper\Test\VarDumperTestCase;
...
array:24 [
  ...
  "obj" => Debug\Symfony\Component\VarDumper\Tests\Fixture\DumbFoo {#%d
    +foo: "foo"
    +"bar": "bar"
  }
  "closure" => Closure {{$r}
    class: "Debug\Symfony\Component\VarDumper\Tests\CliDumperTest"
    this: Debug\Symfony\Component\VarDumper\Tests\CliDumperTest {{$r} …}
    parameters: array:2 [
      "\$a" => []
      "&\$b" => array:2 [
        "typeHint" => "PDO"
  ...
  8 => &1 null
  "sobj" => Debug\Symfony\Component\VarDumper\Tests\Fixture\DumbFoo {#%d}
  "snobj" => &3 {#%d}
  "snobj2" => {#%d}
  "file" => "{$var['file']}"
  b"bin-key-é" => ""
...
stream resource {@{$ref}
  ...
  eof: false
  options: []
  ⚠: Debug\Symfony\Component\VarDumper\Exception\ThrowingCasterException {{$r}
