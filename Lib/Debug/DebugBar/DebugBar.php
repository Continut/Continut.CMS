...
use ArrayAccess;
use \Debug\DebugBar\DataCollector\DataCollectorInterface;
use \Debug\DebugBar\Storage\StorageInterface;

/**
 * Main Debug\DebugBar object
 *
 * Manages data collectors. Debug\DebugBar provides an array-like access
 * to collectors by name.
 *
 * <code>
 *     $debugbar = new Debug\DebugBar();
...
class DebugBar implements ArrayAccess
{
    ...
    {
        throw new DebugBarException("Debug\DebugBar[] is read-only");
    }
