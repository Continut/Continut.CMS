    ...
    <ul class="nav navbar-nav navbar-right">
        <li role="presentation" class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false"><i
                    class="fa fa-fw fa-question-circle"></i> <?= $this->__("login.helpmenu.gettingStarted") ?> <span
                    class="caret"></span></a>
            <ul class="dropdown-menu" role="menu">
                <li><a href="#"><span
                            class="fa fa-fw fa-book"></span> <?= $this->__("login.helpmenu.checkDocumentation") ?></a>
                </li>
                <li class="divider"></li>
                <li><a href="#"><span
                            class="fa fa-fw fa-youtube-play"></span> <?= $this->__("login.helpmenu.checkHowToEditors") ?>
                    </a></li>
            </ul>
        </li>
    </ul>
