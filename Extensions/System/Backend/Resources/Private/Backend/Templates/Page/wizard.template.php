                ...
                <div class="radio">
                    <label>
                        <input type="radio" value="before" name="page_placement"
                               id="before_page"> <?= $this->__('backend.page.wizard.placement.before') ?>
                    </label>
                </div>
            <?php endif ?>
            <div class="radio">
                <label>
                    <input type="radio" value="inside" name="page_placement" id="inside_page"
                           checked> <?= $this->__('backend.page.wizard.placement.inside') ?>
                </label>
            </div>
            <?php if ($page): ?>
                <div class="radio">
                    <label>
                        <input type="radio" value="after" name="page_placement"
                               id="after_page"> <?= $this->__('backend.page.wizard.placement.after') ?>
                    </label>
                </div>
            <?php endif; ?>
        </div>
        <div class="col-sm-12 col-md-8">
            ...
            <div id="wizard_pages">
                <div class="row page-line form-group">
                    <div class="col-sm-8">
                        <input type="text" name="page[names][]" class="form-control"
                               placeholder="<?= $this->__('backend.page.wizard.placeholder.title') ?>">
                    </div>
                    <div class="col-sm-4">
