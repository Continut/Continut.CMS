...
insert  into `sys_user_sessions`(`session_id`,`session_data`,`session_expires`,`user_id`,`user_type`) values ('13rbukec3rharjcu74bl8jvnb3','PHPDEBUGBAR_STACK_DATA|a:0:{}user_id|s:1:\"1\";fullname|s:17:\"Amazing Sniperman\";',1453667690,NULL,NULL);
