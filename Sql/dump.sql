...
insert  into `sys_files`(`id`,`filename`,`filesize`,`location`,`mime`,`created_at`,`modified_at`,`mount_id`) values (1,'panda-trees-woods-990-dl_76256_990x557.jpg',796745,'Media/','image/jpeg',NULL,NULL,1),(2,'1.jpg',19859,'Media/','image/jpeg',NULL,NULL,1),(3,'Solaris_Trollino_12MB_obsługujący_linię_B.jpg',2295217,'Media/','image/jpeg',NULL,NULL,1),(4,'happiness age main.jpg.jpg',78911,'Media/','image/jpeg',NULL,NULL,1),(5,'Bufo_periglenes2.jpg',3103874,'Media/','image/jpeg',NULL,NULL,1),(6,'Terrain-Image-PNG-03877-540x432.png',NULL,'Media/','image/png',NULL,NULL,1),(7,'Mario_png.png',NULL,'Media/','image/png',NULL,NULL,1);
...
insert  into `sys_user_sessions`(`session_id`,`session_data`,`session_expires`,`user_id`,`user_type`) values ('qns66vmoh8g83dbmegvfatk4j5','PHPDEBUGBAR_STACK_DATA|a:0:{}user_id|s:1:\"1\";fullname|s:17:\"Amazing Sniperman\";',1453310858,NULL,NULL);
