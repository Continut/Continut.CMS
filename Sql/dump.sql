...
insert  into `sys_user_sessions`(`session_id`,`session_data`,`session_expires`,`user_id`,`user_type`) values ('2ktv0la02cps9sk58soq1vgpm6','PHPDEBUGBAR_STACK_DATA|a:0:{}',1439141685,NULL,NULL),('9p8b84b3327nq1vgvqlefe81j3','PHPDEBUGBAR_STACK_DATA|a:0:{}user_id|s:1:\"1\";fullname|s:17:\"Amazing Sniperman\";',1439141742,NULL,NULL);
